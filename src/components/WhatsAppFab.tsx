...
export default function WhatsAppFab() {
  return (
    ...
    >
      ...
      <span className="relative grid place-items-center w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-2xl shadow-green-900/30 transition-colors">
