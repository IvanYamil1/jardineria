...
export default function WhatsAppFab() {
  return (
    ...
    >
      ...
      <span className="relative grid place-items-center w-14 h-14 bg-brand-600 hover:bg-brand-700 text-white rounded-full shadow-2xl shadow-black/30 ring-2 ring-white/20 transition-colors">
